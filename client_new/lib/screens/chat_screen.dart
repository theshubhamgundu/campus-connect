...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // Removed ImagePicker and FilePicker functionality
  ...
  Future<void> _pickImage(dynamic source) async {
    // Implementation removed - image picking not available
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Image picking not available')),
    );
  }

  // File picking functionality removed
  Future<void> _pickFile() async {
    // Implementation removed - file picking not available
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('File picking not available')),
    );
  }
